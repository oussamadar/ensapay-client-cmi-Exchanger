...
@XmlRootElement(name = "getListCreanciersResponse", namespace = "http://app.com/creanciers-service")
public class GetListCreanciersResponse {

    @XmlElement(namespace = "http://app.com/creanciers-service", nillable = true)
